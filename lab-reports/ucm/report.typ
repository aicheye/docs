...
#let variables = {
  [
    ...
    $f$ : frequency---the number of revolutions per second (hertz / $h z$) 
  ]
}
...
#show: ilm.with(
  ...
  author: "Sean Yang",
  date: datetime(year: 2024, month: 03, day: 13),
  abstract: [
...
= Hypothesis
Based on the following accepted formulae:
...
(for definitions of symbols, please refer to #link(<vars>)[Appendix A])
